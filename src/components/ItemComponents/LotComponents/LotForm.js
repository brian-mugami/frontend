...
<div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Lot {title}</h2>
              ...
              *Lot Name
              ...
              <div className="mt-2">
                <input
                  ...
                  required defaultValue={lotData ? lotData.lot : ""}
              ...
              *Batch
              ...
              <div className="mt-2">
                <input
                  ...
                  name="batch" 
                  placeholder="Batch"
                  required defaultValue={lotData ? lotData.batch : ""}
