...
<div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Category {title}</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">Add categories here.</p>
              ...
              *Category Name
              ...
              <div className="mt-2">
                <input
                  ...
                  required defaultValue={categories? categories.name:""}
            ...
            <div className="sm:col-span-1">
              ...
              <div className="mt-2">
                <select
                  id="country"
                  nname="account"
                  required defaultValue={categories? categories.account.account_name: ""}
