...
<div className="border-b border-gray-900/10 pb-12">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Item Creation</h2>
          <p className="mt-1 text-sm leading-6 text-gray-600">Input item details here.</p>
          ...
          <div className="sm:col-span-2 sm:col-start-1">
              ...
              <div className="mt-2">
                <input
                  ...
                  required defaultValue={itemData ? itemData.item_name:""}
              ...
              *Price
              ...
              <div className="mt-2">
                <input
                  type="number"
                  name="price"
                  required defaultValue={itemData ? itemData.price:""}
                  placeholder="Price"
            ...
            <div className="sm:col-span-1">
              ...
              <div className="mt-2">
                <select
                  id="country"
                  name="category"
                  required defaultValue={itemData ? itemData.category.name:""}
