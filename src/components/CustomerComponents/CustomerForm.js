        ...
        <div className="md:grid  md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-base font-semibold leading-6 text-gray-900">Customer {title}</h3>
              <p className="mt-1 text-sm text-gray-600">Input Customer details here</p>
            </div>
          </div>
                  ...
                  <div className="grid grid-cols-6 gap-6">
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <input
                        type="text"
                        name="cussname"
                        required defaultValue={cusData ? cusData.customer_name:""}
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      ...
                      <input
                        name="cuscon" type="text" defaultValue={cusData ? cusData.customer_contact:""}
                        className="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        placeholder=""/>
                    </div>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <select
                        name="account" required defaultValue={cusData ? cusData.account.account_name:""}
                        className="block w-full rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        >
