...
async function InventoryBalancesLoader(){
    ...
    const response = await fetch('https://inentory-test.onrender.com/inventory-balances', {
        method: "get",
        headers: {
...
async function InvAdjAccountsLoader(){
    ...
    const response = await fetch("https://inentory-test.onrender.com/inventory-adjustment/account", {
        method: "get",
        headers: {
            "Authorization": "Bearer "+ token
        }
